	...
	return (
		<>
			...
			>
				...
				<TabPanels mt='56px'>
					<TabPanel>
						<Box display='flex' w='1080px' h='270px' borderBottom='1px solid #DDDDDD'>
							...
							<Text
								...
								color='#999999'
							>
								신규 프로젝트를 효과적으로 관리하기 위한 애자일 도구인 JIRA의 사용 경험에 대해
								소개합니다.
							</Text>
							...
							<Box position='absolute' display='flex' mt='229px' w='850px' h='21px'>
								<Text w='703px' color='#999999' gap='10px' h='21px'>
									Jay | 2022.11.05
								</Text>
								<Box display='flex' alignItems='center' mr='16px'>
									<Image mr='4px' h='15px' alt='eyeIcon' src='https://bit.ly/dan-abramov' />
